            ...
            <div class="col-md-9">
                <div class="profile-body">
                    <div class="panel panel-profile">
                        ...
                        <div class="panel-body margin-bottom-50" ng-hide="loading" ng-init="init('{{{Crypt::encrypt(get_class($school) . '.' . $school->getKey())}}}}')">
                            <!-- LOADING ICON =============================================== -->
                    ...
                    @if(Auth::guest())
                        ...
                        <div class="post-comment">
                            <h3>评论一下</h3>
                            <form ng-submit="submitComment('{{{Crypt::encrypt(get_class($school) . '.' . $school->getKey())}}}}', '{{Auth::user()->nickname}}')"> <!-- ng-submit will disable the default form action and use our function -->
